...
// Dla wszystkich i takich, że l <= i < r, zaktualizuj A_i na min(A_i, x)

// Dla wszystkich i takich, że l <= i < r, zaktualizuj A_i na max(A_i, x)

// Znajdź maksymalną wartość A_i dla l <= i < r

// Znajdź minimalną wartość A_i dla l <= i < r

// Oblicz sumę wartości A_i dla l <= i < r

// Dla wszystkich i takich, że l <= i < r, dodaj x do A_i

// Dla wszystkich i takich, że l <= i < r, ustaw A_i na x
